...
พยายามเลี่ยงการติดตั้ง `Library` โดยไม่จำเป็น *ความคิดเห็นส่วนตัว* ฟังก์ชันไหนที่พอจะเขียนเองได้ หรือ ให้ ai ช่วยเขียนเฉพาะฟังก์ชันจะดีกว่า หากจำเป็นต้องติดตั้ง `Library` เสริมควรเลือก `Library` ที่มีการอัปเดทสม่ำเสมอ เพื่อที่จะเป็นประโยชน์ในอนาคตสำหรับการ Migrate Version Flutter ให้เกิดปัญหาน้อยที่สุด
